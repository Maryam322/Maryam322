...
Python • Django • Django REST Framework • Flask • REST APIs
...
**Features:** Authentication, property management, agent profiles, property search, visit requests, reviews and REST APIs.

**Tech:** React.js • Django REST Framework • JWT • PostgreSQL
...
**Tech:** Python • Django • YOLOv8 • React Native • REST API
